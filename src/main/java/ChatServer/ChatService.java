...
public class ChatService {
    ...
    @Resource(mappedName="jdbc/messenger")
    ...
    //select distinct id from CHATUSER
    @GET
    @Path("userids")
    public List<User> getAllUserId() {
        return em.createQuery("select u.id from User u",User.class).getResultList();
    }
    ...
    public Message createMessage(
        ...
        Message message = new Message(text, sender, conversation);
        if((message == null))
        {
